...
public class TS_005_CHECKER {
	...
	@Test(priority = 6)
	public void TC_06_To_verify_input_of_correct_CHECKER_User_ID_and_correct_Password_and_click_login_button_or_Press_Enter() 
			throws InterruptedException {
	...
	public void TC_10_Check_the_eye_icon_visible_or_not_in_the_Password_field () 
		...
		//_10.Check the eye icon visible or not in the Password field
		   WebElement UsernameField = driver.findElement(By.id("txtUserId"));
		   UsernameField.sendKeys("CHECKER1");	
		   Thread.sleep(2000);
		   WebElement PasswordField = driver.findElement(By.id("txtPwd"));
		   PasswordField.sendKeys("Login@123");
		   Thread.sleep(3000);
	...
	@Test(priority = 10)
	public void TC_11_Check_the_eye_icon_visible_or_not_in_the_Password_field () { 	
